...
public class ServicePost {
 ...
 public boolean modifierPost(Post post) {
        String url = Statics.BASE_URL + "post/updatePostMobile/"+post.getId_post()+"&titre=" + post.getTitre() +"&auteur="+post.getAuteur() +"&imgPost=" + post.getImg_post()+ "&datePost="+post.getDate_post()+"&rate="+post.getRate();
        req.setUrl(url);
  ...
  public boolean deletePost(int idPost ) {
        String url = Statics.BASE_URL +"post/deletePostMobile/?idPost="+idPost;
