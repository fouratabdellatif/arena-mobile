...
public class ModifierPostForm extends BaseForm {
   Form current;
    public ModifierPostForm( Resources res, Post r) {
        ...
        TextField tilte = new TextField(r.getTitre() , "Objet" , 20 , TextField.ANY);
        TextField author = new TextField(r.getAuteur() , "Description" , 20 , TextField.ANY);
        TextField imapge = new TextField(r.getImg_post() , "Objet" , 20 , TextField.ANY);
        TextField date = new TextField(r.getDate_post() , "Description" , 20 , TextField.ANY);

               TextField rete = new TextField(String.valueOf(r.getRate()) , "Etat" , 20 , TextField.ANY);
