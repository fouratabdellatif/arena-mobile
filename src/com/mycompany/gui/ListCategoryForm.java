...
public class ListCategoryForm extends BaseForm {
    ...
    public ListCategoryForm(Resources res) {
        ...
        ArrayList<Category> list = ServiceCategory.getInstance().getCategory();
        int i = 0;
        for (Category c : list) {
            i++;
            addCategory(c, res, i);
    ...
    private void addCategory(Category c, Resources res, int i) {

        int height = Display.getInstance().convertToPixels(16f);
        int width = Display.getInstance().convertToPixels(12f);

        Container cnt = BorderLayout.center(current);

        Label CategorieTxt = new Label("Category " + i, "NewsTopLine2");
        Label name = new Label("Category Name: " + c.getName(), "NewsTopLine2");
        Label desc = new Label("Description: " + c.getDesc(), "NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if (ServiceCategory.getInstance().deleteCategory(c.getId())) {
